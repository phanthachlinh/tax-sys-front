...
import { IFile, FileActions } from '../ducks/file/file';
  ...
  render(){
    return(
      ...
      {!this.state.editMode &&
        <>
         <StyledTitleWrapper>
            <a target="_black" href={'http://localhost:8001/static/'+this.props.file.filename}>{this.state.title}</a>
         </StyledTitleWrapper>
...
function mapDispatchToProps(dispatch:any){
  return{
    deleteFile:(id:number)=>{dispatch(FileActions.deleteFi(id))},
